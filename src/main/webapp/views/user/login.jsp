        ...
        <div class="helloworld-login">
            ...
            <form action="<%=contextPath %>/login.me" method="post" class="was-validated">
                ...
                <input type="password" class="form-control" placeholder="비밀번호를 입력하세요."
                       name="userPwd" id="pwd" style="width: 100%; height: 45px; border-radius: 5px; border: 1px solid rgb(181, 181, 181);" required>
                       
                <!-- 오류 메시지 출력 공간 -->
                <div class="alert alert-danger" id="error-message" style="display: <%=(alertMsg != null) ? "block" : "none"%>;">
