              ...
              <table class="order-window-2-dt ">
                    <thead>
                      <tr>
                        ...
                        <th class="order-window-2-menu cursor-pointer " >여행약관</th>
                        <th class="order-window-2-menu cursor-pointer">개인정보수집이용</th>
                        <th class="order-window-2-menu cursor-pointer">고유식별정보수집이용</th>
                        <th class="order-window-2-menu cursor-pointer">개인정보 제3자제공</th>
                    </tr>
                </thead>
               </table>
...
<!-- 숨겨진 내용들이 보여질 div들 -->
            ...
            <div class="cancle-provision-content content-all cursor-pointer">
               <!-- 이미지or icon -->
               <p>
         ...
         <div class="order-window-3 ow-all">
            ...
            <div class="ow3-content">
               ...
               <div class="form-group">
                  <label for="adult-select">성인</label> 
                  <select class="form-control" id="adult-select" onchange="updateForm()">
               ...
               <div class="form-group">
                  <label for="infant-select">유아</label> 
                  <select class="form-control" id="infant-select" onchange="updateForm()">
               ...
               <table summary="여행자 정보확인란 입니다." class="board-list02"
                  ...
                  <thead>
                     ...
                     <tr id="repInfo">
                        ...
                        <td
                           style="padding: 7px 0px 2px; font-size: 11px; color: rgb(90, 90, 90); text-align: center; letter-spacing: -0.025em; border: 1px solid rgb(220, 220, 220);">
                           <select class="bsc1" id="CustomerNationality"
                           name="CustomerNationality" title="국적" style="width: 66px;">
                              <option value="KOREA">내국인</option>
                              <option value="FOREIG">외국인</option>
                        </select>
                        </td>
                        <td
                           style="padding: 7px 0px 2px; font-size: 11px; color: rgb(90, 90, 90); text-align: center; letter-spacing: -0.025em; border: 1px solid rgb(220, 220, 220);">
           ...
           IMP.init("imp02350258");
               ...
               function requestPay() {
                  ...
                  data : {
                     ...
                     bhNo : document.getElementById('sel1').value,
                     adult : Number(document.getElementById('adult-select').value)+1,
                     child : document.getElementById('infant-select').value,
                     flight :'<%=p.getFlight() %>',
                     pointU : $("#usePoint").val() ,
                     totalPay : document.getElementById('totalPay').innerText,
                     
                     CustomerKrNM : document.getElementById('CustomerKrNM').value,
                     CustomerEnLastNM : document.getElementById('CustomerEnLastNM').value,
                     CustomerEnFirstNM : document.getElementById('CustomerEnFirstNM').value,
                     ...
                     CustomerPPNO : document.getElementById('CustomerPPNO').value,
                     CustomerPPExpirationDT :document.getElementById('CustomerPPExpirationDT').value
                  },
                  success : function(res) {
                     if(res == '0001'){
                        alert('상품 구매가 성공적으로 완료되었습니다.');
                        location.href = "<%=contextPath%>/complete.or";
                     }else{
                        alert('결제에 실패하였습니다.'+res);
        ...
        $('#sel1').change(function() {
          ...
          const cNum = Number($('#infant-select').val());
           ...
           if(sel1 == 1){
             ...
             $('#totalPay').html(result + 100000*(aNum+cNum));
           }else if(sel1 == 3){
             $('#totalPay').html(result + 150000*(aNum+cNum));
           }else if(sel1 == 4){
             $('#totalPay').html(result + 200000*(aNum+cNum));
           }else{
             $('#totalPay').html(result + 250000*(aNum+cNum));
           }
        });
